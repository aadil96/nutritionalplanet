                        ...
                        <div class="product-content-box clearfix">
                            <div class="img-box">
                                <div class="single-product-carousel-content-box owl-theme owl-carousel">
                                    <div class="item">
                                        <img src="{{ asset('images/products/'.$product->slug.'-thumbnail.jpeg')}}" alt="Awesome Image" />
                                    </div>
                                    <!-- /.item -->
                                    <div class="item">
                                        <img src="{{ asset('images/products/'.$product->slug.'-carousel-1.jpeg')}}" alt="Awesome Image" />
                                    </div>
                                    <!-- /.item -->
                                    <div class="item">
                                        <img src="{{ asset('images/products/'.$product->slug.'-carousel-2.jpeg')}}" alt="Awesome Image" />
                                    </div>
                                    <!-- /.item -->
                                </div>
