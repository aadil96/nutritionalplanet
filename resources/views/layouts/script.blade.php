...
<script src="{{ asset('assets/menuzord/js/menuzord.js') }}"></script>
<script src="{{ asset('assets/bootstrap-select/dist/js/bootstrap-select.min.js') }}"></script>
<script src="{{ asset('assets/jquery.isotope.js') }}"></script>
<!-- waypoints js -->
<script src="{{ asset('assets/waypoint.js') }}"></script>

<!-- theme custom js  -->
<script src="{{ asset('js/default-map.js') }}"></script>
<script src="{{ asset('js/custom.js') }}"></script>

{{-- <script type="text/javascript" src="{{ asset('../../../../cdnjs.cloudflare.com/ajax/libs/js-cookie/2.1.2/js.cookie.min.js') }}"></script> --}}
